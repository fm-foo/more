...
function createHelpMessage()  
  ...
  rMessage.type = sCmd;
  rMessage.text = rMessage.text .. "The \"/mcds1 1+ #d6\" command is used to roll a set of d6. 1s = 1 damage, 2s = 2 damage, and 6s equal 1 special.\n"; 
