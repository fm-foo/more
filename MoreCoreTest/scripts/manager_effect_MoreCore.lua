-- Basic effect parsing - taken from 3.5E ruleset v3.3.4
-- Setup to handle simple number effects - e.g. PAIN: -1
-- These can be used in custom dice rollers to look for specific effects and use the modifiers as appropriate
-- e.g. local nPAINMod = getEffectsBonus(rSource, {"PAIN"}, true, nil, rTarget);
--
-- TODO: Work out how to use dice effects efficiently.
