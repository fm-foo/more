...
function initLastDice(aDice)
	Debug.console("initiative.initLastDice: 4, ");
...
function orderDiceResults(rRoll)
	Debug.console("initiative.orderDiceResults: 3, ");
	
  -- Sort rRoll.aDice table based off a.result (the dice result)
		Debug.console("Disadvantage!");
...
function onLanded(rSource, rTarget, rRoll, rActor)
	Debug.console("initiative.onLanded: 2, " .. getDatabaseNode());
...
function createRoll(sDice, sDesc)
	Debug.console("initiative.createRoll");
...
function createChatMessage(rSource, rRoll)  
	Debug.console("initiative.createChatMessage");
...
function onDiceTotal( messagedata )
	Debug.console("initiative.onDiceTotal");
