...
Debug.console("aRerollDice: ",#aRerollDice, aRerollDice);
  ...
  elseif nHitLocation == 5 then sHitLocation = "Right Arm";
  elseif nHitLocation == 6 then sHitLocation = "Left Arm";
  elseif nHitLocation >= 7 and nHitLocation <= 8 then sHitLocation = "Right Leg";
  else sHitLocation = "Left Leg";
  end
