...
The main functions are: stringify, parse.
 ...
 * They are not recursive. Such a structure cannot be specified in 
...
table value null (which is just an empty table) to indicate null values.
