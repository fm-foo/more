...
--	Debug.chat("rRoll.sDesc: ", rRoll.sDesc, "sDicePattern", sDicePattern);
...
--  Debug.chat(rRoll.sDescriptionParam);
 ...
 local rRoll = { sType = sCmd, sDesc = sDesc, aDice = aFinalDice, aOp = sOp, nMod = nMod, nSave = tonumber(sSave), sDescriptionParam = sDescriptionParam, sDicePattern = sDicePattern };
 return(rRoll);
...
function createChatMessage(rSource, rRoll)  
  local rMessage = ActionsManager.createActionMessage(rSource, rRoll);
    ...
    rMessage.text = rMessage.text .. rRoll.sDescriptionParam .. "\nTarget: " .. rRoll.aSave .. "\nRoll: " .. rRoll.sDicePattern .. "\n[" .. rRoll.aSaveResult .. "] " .. rRoll.aTotal;
